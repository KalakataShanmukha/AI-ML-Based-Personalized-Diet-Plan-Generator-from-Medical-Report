...
def generate_diet(text):
    ...
    # Expanded meal options for 7 unique days
    meal_options = {
        "Breakfast": [
            "Oats with fruits", "Vegetable upma", "Idli with sambar",
            "Poha", "Dosa with chutney", "Multigrain toast", "Smoothie bowl"
        ],
        "Lunch": [
            "Brown rice with dal", "Chapati with veg curry", "Millet khichdi",
            "Quinoa salad", "Grilled chicken salad", "Paneer stir fry", "Lentil soup"
        ],
        "Snacks": [
            "Fruit bowl", "Roasted nuts", "Sprouts salad",
            "Yogurt with berries", "Hummus with veggies", "Boiled eggs", "Protein smoothie"
        ],
        "Dinner": [
            "Vegetable soup", "Grilled vegetables", "Light salad",
            "Steamed fish with veggies", "Stuffed bell peppers", "Zucchini noodles", "Tofu stir fry"
        ]
    }
