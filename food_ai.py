...
def generate_pdf_bytes(name, age, condition, df, avoid, lifestyle):
    ...
    table.setStyle(TableStyle([
        ...
        ("BACKGROUND", (0,0), (-1,0), colors.lightgrey),  # Darker header
...
if st.button("🍽 Generate Diet Plan") and uploaded_file:
    ...
    # -------------------- STYLE TABLE HEADERS ONLY (darker) --------------------
    header_color = '#D3D3D3'  # slightly darker light gray
