...
# -------------------- TITLE --------------------
st.markdown("""
<h1 style='text-align:center;'>🥗 AI+DietPlanner</h1>
...
manual_text = st.text_area("📝 Doctor's Prescription (optional)", height=120)
...
<style>
.stApp {
    background-image: url("https://www.freepik.com/free-photo/summer-composition-with-appetizing-fruits-space-messages_1150113.htm#fromView=search&page=3&position=19&uuid=25f63b1d-b65b-4c0a-b22f-39bb78250e60&query=diet+plan+background+for+app");
