...
def generate_diet(text, diet_type="Veg"):
    ...
    lifestyle = []
    lifestyle_keywords = {
        "exercise": "Exercise at least 30 minutes daily",
        "sleep": "Sleep 7–8 hours daily",
        "water": "Drink 2–3 liters of water",
        "stress": "Manage stress and relax",
        "diet": "Maintain a balanced diet",
        "avoid": "Limit processed and high-fat foods",
        "walk": "Include walking or light cardio daily"
    }

    for key, advice in lifestyle_keywords.items():
        if key in text.lower():
            lifestyle.append(advice)
