...
def generate_diet(text, category="Veg"):
    ...
    breakfast_list = random.choices(meal_options["Breakfast"], k=7)
    lunch_list     = random.choices(meal_options["Lunch"], k=7)
    snacks_list    = random.choices(meal_options["Snacks"], k=7)
    dinner_list    = random.choices(meal_options["Dinner"], k=7)
